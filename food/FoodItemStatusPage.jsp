...
<%	
	...
	boolean b=false;
		...
		try 
         ...
         ResultSet rs;
 		 rs = stmt.executeQuery("SELECT `food_name` FROM `fooditem`" + "ORDER BY `food_name` asc");
		 while ( rs.next() ) 
            {
...
%>
	...
	%>
		 ...
		 <!-- header part -->
		 <h1 id="title"><b><center>Select Food Item To View Status</center></b></h1>

	
		 <!-- Info part -->
		 <form action="FoodItemStatusPageButton.jsp">
		 <center>
		 <table>
