...
%>
	 ...
	 <!-- header part -->
	 <h1 id="title"><center>Enter Your Admin New Password</center></h1>

	 <!-- Info part -->
	 <form action="http://localhost:8080/examples/AdminPasswordChangeButton.jsp">
	 <center>
	 <table>
	 ...
	 <option value="<%=acctype%>">Admin</option></select></td></tr>
	 </table>
	 <table>
	 <tr><td><a href="http://localhost:8080/examples/LoginPage.jsp"><input type="button" name="button" value="Cancel" class="button"></td>
